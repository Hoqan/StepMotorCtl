...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : PEPin PEPin PEPin PEPin
                           PEPin PEPin */
  GPIO_InitStruct.Pin = MANU_Pin|BACK_Pin|RIGHT_Pin|LEFT_Pin
                          |FWD_Pin|AUTO_Pin;
  ...
  GPIO_InitStruct.Pin = DI_A_Pin|DI_B_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  ...
  GPIO_InitStruct.Pin = CONF_Pin|ADD_Pin|SUB_Pin|SETTINGS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOG, &GPIO_InitStruct);

  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = IN5V_DIR_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(IN5V_DIR_GPIO_Port, &GPIO_InitStruct);
